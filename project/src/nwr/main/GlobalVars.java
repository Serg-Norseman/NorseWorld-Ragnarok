...
public final class GlobalVars
{
    ...
    public static NWDatabase nwrBase;
    ...
    public static boolean Debug_ShowFPS = false;
    public static boolean Debug_DevMode = true;
    public static boolean Debug_Divinity = true;
    public static boolean Debug_Fly = false;
    public static boolean Debug_Swim = false;
    public static boolean Debug_TestVanaheim = false;
    public static boolean Debug_TestWorldGen = false;

    public static boolean Debug_Freeze = false;
    public static boolean Debug_Fury = true;
    public static boolean Debug_CheckCrPtr = false;
    public static boolean Debug_CheckScent = false;
    public static boolean Debug_Silent = false;
    public static boolean Debug_ManaRegen = false;
}
