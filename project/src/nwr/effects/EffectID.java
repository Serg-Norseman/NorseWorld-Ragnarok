...
public enum EffectID
{
    ...
    */
    ...
    public static final int eid_First = 0;
    public static final int eid_Last = 221;

    private final int intValue;
    private static HashMap<Integer, EffectID> mappings;

    private static HashMap<Integer, EffectID> getMappings()
    {
        synchronized (EffectID.class) {
            if (mappings == null) {
    ...
    public static EffectID forValue(int value)
    {
