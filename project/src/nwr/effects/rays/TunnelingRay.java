 ...
 */
public final class TunnelingRay extends EffectRay
{
    public TunnelingRay()
    {
    }
    ...
    public void TileProc(int aX, int aY, RefObject<Boolean> aContinue)
    {
        ...
        NWTile tile = this.Field.getTile(aX, aY);
        if (tile == null) {
        ...
        switch (fgp) {
            ...
            case PlaceID.pid_Tree:
                GlobalVars.nwrWin.showText(this.Creature, Locale.getStr(RS.rs_ThereAreNowHoles));
                break;
