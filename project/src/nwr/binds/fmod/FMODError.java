...
public final class FMODError
{
    public static String getString(RESULT errcode)
    {
        switch (errcode) {
            case OK:
                return "No errors.";
            case ERR_ALREADYLOCKED:
            ...
            case ERR_DSP_TOOMANYCONNECTIONS:
