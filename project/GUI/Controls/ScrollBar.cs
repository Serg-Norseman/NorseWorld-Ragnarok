...
namespace NWR.GUI.Controls
{
    public sealed class ScrollBar : BaseControl
    {
            ...
            : base(owner)
        {
            ...
            fThumb = NWResourceManager.LoadImage(scr, "itf/SBThumb.tga", BaseScreen.clNone);
            fHBack = NWResourceManager.LoadImage(scr, "itf/SBHBack.tga", BaseScreen.clNone);
            fHArrows = NWResourceManager.LoadImage(scr, "itf/SBHArrow.tga", BaseScreen.clNone);
            fVBack = NWResourceManager.LoadImage(scr, "itf/SBVBack.tga", BaseScreen.clNone);
            fVArrows = NWResourceManager.LoadImage(scr, "itf/SBVArrow.tga", BaseScreen.clNone);
        }
